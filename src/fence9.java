...
//		PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("src/test.out")));
		...
		InputReader in = new InputReader(new FileInputStream("fence9.in"));
...
//		System.out.println(b);
		...
		/*
		 * picks theorem : https://artofproblemsolving.com/wiki/index.php/Pick%27s_Theorem
		 */
